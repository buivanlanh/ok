...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <textarea id="demo" name="Discription" class="form-control ckeditor" rows="4"></textarea>
              </div>
              <div class="form-group">
                <label for="inputStatus">Khuyến Mãi</label>
                <input type="text"name="UnitSale" id="inputName" class="form-control">
            <label for="inputStatus">Hãng</label>
                ...
                <div class="form-group">
                  ...
                  <input  type="text" name="UnitPrice" id="inputClientCompany" class="form-control">
                </div>
                <div class="form-group">
      ...
      <div class="row">
        <div class="col-12">
         <center> <input type="submit" name="add" value="Thêm Sản Phẩm" </center>
          <?php
              if (isset($_POST['add']) )
               {
                 ...
                 $unitsale=$_REQUEST['UnitSale'];
                 $img=$_FILES['avatar']['name'];
                 $path=$_FILES['avatar']['tmp_name'];
                 $p->upload($path,$img);
                $p->new_query("INSERT INTO products(ProductName,UnitPrice,Discription,UnitSale,avatar) VALUES ('$name','$unitprice','$discription','$unitsale','$img')");
